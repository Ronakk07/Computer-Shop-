...
<!--header-->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
				<a href="index.html"><img src="Images/complogo.jpg" alt="" width="235px" height="160px"></a>
			</div><!--End of col-5-->
			<div class="col-sm-8 my_menu">
				...
				<div class="navbar-header">
					...
					<div class="collapse navbar-collapse " id="mynavbar">
						...
						<h1 style="font-family:verdona;font-size:35px;color:red;">&nbsp;&nbsp; Allocate Employee&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--Welcome  <?php $username1="Rakesh"; echo "$username1";
			...
			<div class="container">
				...
				<div class="col-sm-6 col-xs-6">
					<?php
						...
						<div class="col-sm-6 col-xs-6">
								<div class="wrap" style="margin-left: 350px;margin-top: -5px;">
									<form action="connectivity5.php" method="POST">
  										<h1 align='center' style="font-family:verdona;font-size:35px;color:yellow;"></h1>
											...
											<input type="Submit" name="button1" value="Submit" class="button" style="width: 120px;"><br>
									</form>
